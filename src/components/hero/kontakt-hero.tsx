...
export function KontaktHero({ eyebrow, title, description }: KontaktHeroProps) {
  return (
    <section className="relative overflow-hidden bg-cream pt-12 pb-16 lg:pb-20 lg:pt-16">
      ...
      <Container className="relative">
        <div className="grid items-end gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
          <div className="relative z-20 max-w-2xl pt-4 lg:pt-8">
          ...
          <div className="relative mx-auto w-full max-w-md lg:mx-0 lg:max-w-none lg:justify-self-end">
            ...
            />
            <div className="relative z-10 lg:-mr-4 lg:translate-y-4">
              <Image
